...
class sis():
	def __init__(self):
		...
		self.sl=Label(self.sis,text='Student Enquiry System',bg='white',fg='brown',font=('arial',60))
		self.sl.place(x=265,y=25)

		self.sf=Frame(self.sis,width=900,height=450,bg='grey')
...
#ENTRIES-RIGHT
	...
	def save(self):
		...
		if self.nm=='' or self.ad=='' or self.mon=='' or self.mid=='' or self.i=='' or self.sor=='' or self.refr=='':
			...
			for y in range(1):
				self.pin=random.randint(100,999)
				#print(self.pin)
			
			self.s=smtplib.SMTP('smtp.gmail.com',587)
			self.s.starttls()
			self.s.login('conquerordanish@gmail.com','gadgets720')
			self.message=str(self.enqno)
			self.s.sendmail('conquerordanish@gmail.com',self.mid,self.message)
			self.s.quit()
			print('sent')
